import { LineChart, Line, AreaChart, ResponsiveContainer, YAxis, Area, Tooltip, CartesianGrid, linearGradient, XAxis } from 'recharts';
...
export const AreaCharts = () => {
    ...
    return (
        <ResponsiveContainer width="50%" height="80%">
            < AreaChart width="50%" height="80%" data={data}
            >
                <defs>
